...
const Features = () => {
  ...
  return (
    <section className="sm:pt-10 sm:pb-14 pb-6 bg-white">
      <div className="max-w-6xl mx-auto px-6 pt-10 pb-6 text-center">
        <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-6 sm:mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-10">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-gray-700 mb-1 sm:mb-2">
                {feature.title}
              </h3>
